...
str(adminr_members$resource[1])

adminr_members$resource[[1]]$group_profile$answers[[1]]$answer

lauf <- seq(n_members)

data_frame(id = adminr_members$resource[[1]]$id, 
           answer1 = adminr_members$resource[[1]]$group_profile$answers[[1]]$answer,
           answer2 = adminr_members$resource[[1]]$group_profile$answers[[2]]$answer)
...
map_dfr(adminr_members$resource[1:3], extract, c("id", "name"))
